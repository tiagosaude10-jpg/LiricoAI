...
if _model_root:
    ...
    os.environ.setdefault("HF_HOME", user_cache_dir("LiricoAI"))
...
def main():
    ...
    log_dir = user_log_dir(appname="LiricoAI")
    ...
    logging.debug("cache_dir: %s", user_cache_dir("LiricoAI"))
    logging.debug("data_dir: %s", user_data_dir("LiricoAI"))
